...
class DesignMng
{
  ...
  private:
    ...
    const Command commands_lst[NR_COMMANDS] = {
        ...
        // Export - 3
        {"EXPORT LAYOUT <str_Layout> <str_Path>",
         "Exports layout generated by ICPD to open with other applications. Supported extensions: .cif (Calltech "
         "Intermediate Format), .gds (Graphic Data System II), .c2c (CIF to Cadence Convertion File)"},
        {"EXPORT CELLSIZES <str_Path>",
         "Exports cell sizes file. Supported extension: .est (Mango Parrot Cell Estimative)"},
        {"EXPORT PLACEMENT <str_Path>", "Exports placement generated by ICPD to open with Cadence. Supported "
                                        "extension: .place (Cadence Placement File)"},
        ...
        {"PLACE INSTANCE <str_Layout> <str_Instance> <int_PosX> <int_PosY> <bool_MX> <bool_MY>",
         "Make placement of instance"},
        ...
        {"SET TECHNOLOGY SOI <str_YES/NO>",
         "Set if the current technology supports SOI. Parameter must be \"YES\" or \"NO\""},
        ...
        {"SET MARGINS <float_Left> <float_Right> <float_Top> <float_Bottom>",
         "Set new values to the floorplan margins"},

        {"CALCPINSPOS", "Calculate the pins' position"},

        // CellGen - 9
        {"CELLGEN SELECT <str_Cell>", "Select a cell to generate the layout using Cellgen"},
        {"CELLGEN AUTOFLOW <int_nrIntTracks>", "Try to generate cell layout automatically in the best possible way"},
        {"CELLGEN FOLD <int_nrIntTracks> <int_conservativeFactor>", "Fold the cell's transistors with Cellgen"},
        {"CELLGEN PLACE <int_Saquality> <int_#Attempts> <int_WidthCost> <int_GateMissMatchCost> <int_RoutingCost> "
         "<int_RtDensityCost> <int_#GapsCost>",
         "Place the cell's transistors with Cellgen"},
        ...
        {"CELLGEN ROUTE <int_hPoly> <int_incrementIntTracks> <int_reduceVRt> <int_optimize>",
         "Make the routing of the cell with Cellgen"},
        {"CELLGEN COMPACT <int_diffStretching> <int_griddedPolly> <int_rdCntsCost> <int_maxDiffCnts> "
         "<int_alignDiffConts> <int_reduceLTurns> <int_enableDFM> <int_experimental> <int_debug> <int_timeLimit>",
         "Compact the cell's layout with Cellgen"},

        // Help - 2
        {"HELP", "Print the commands' usage on the screen"},
        {"HELP <str_Command>", "Prints the specified commands with details on the screen. Use double quotes (\"this is "
                               "an example\") for words in the same parameter"},
